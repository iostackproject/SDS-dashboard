...
class MetricTable(tables.DataTable):
    ...
    out_flow = tables.Column('out_flow', verbose_name=_("Out Flow?"), form_field=forms.ChoiceField(choices=[('True', _('True')), ('False', _('False'))]),
                             update_action=UpdateCell)
    in_flow = tables.Column('in_flow', verbose_name=_("In Flow?"), form_field=forms.ChoiceField(choices=[('True', _('True')), ('False', _('False'))]),
                            update_action=UpdateCell)
